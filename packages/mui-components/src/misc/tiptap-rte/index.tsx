 ...
 *
 * Docs: [MUITipTapRte](https://mui-components-docs.vercel.app/components/misc/tiptap-rte)
 *
 * API: [MUITipTapRteProps](https://mui-components-docs.vercel.app/components/misc/tiptap-rte#api)
 */
const MUITipTapRte = ({
  fieldName,
  value,
  ...
  const editor = useEditor({
    ...
    onUpdate: updateProps => {
      onValueChange({
        newValue: updateProps.editor.getHTML(),
        editor: updateProps.editor
      });
      editorOptions?.onUpdate?.(updateProps);
    },
    editorProps: {
