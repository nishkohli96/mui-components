...
export type MUINumberStepperProps = Omit<MUINumberInputProps, 'showMarkers'> & {
  /**
   ...
   * left (decrement) button and vice versa. Accessible labels and behaviour are
   * unchanged; the left button still decreases the value.
   */
  swapIcons?: boolean;
  /**
...
/**
 * `MUINumberInput` with always-visible `-` / `+` stepper buttons
 * flanking the input instead of the native browser steppers.
 * 
 * This component only adds the buttons and disables the
