...
export type MUIDesktopDateTimePickerProps<TDate extends PickerValidDate = PickerValidDate> = {
  /**
   ...
   *
   * @param newValue - New date-time value emitted by MUI X, typed as `TDate | null`.
...
/**
 * Controlled combined date-and-time picker that always renders the desktop,
 * keyboard-first popover UI, regardless of the input device.
 *
 ...
 *
 * Docs: [MUIDesktopDateTimePicker](https://mui-components-docs.vercel.app/v1/components/mui-pickers/date-time)
 *
 * API: [MUIDesktopDateTimePickerProps](https://mui-components-docs.vercel.app/v1/components/mui-pickers/date-time#api)
 */
const MUIDesktopDateTimePicker = <TDate extends PickerValidDate = PickerValidDate>({
  fieldName,
  value: muiValue,
  onValueChange,
  required,
  ...
  if (!dateAdapter) {
    throw new Error(generateDateAdapterErrMsg('MUIDesktopDateTimePicker'));
  }
...
export default MUIDesktopDateTimePicker;
