...
export type MUIDesktopDatePickerProps<TDate extends PickerValidDate = PickerValidDate> = {
  /**
...
/**
 * Controlled date picker that always renders the desktop, keyboard-first
