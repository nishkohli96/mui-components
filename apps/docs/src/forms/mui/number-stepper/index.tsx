    ...
    <FormContainer>
      ...
      >
        <GridContainer>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <FieldVariantInfo title="Custom step (±2), bounded 16–30, custom icons with extra horizontal padding (iconButtonProps override), bolder caption (captionProps override)" />
            <form.Field
              name="targetTemp"
              validators={{
                onChange: ({ value }) =>
