    ...
    pages: [
      {
        ...
        pages: [
          ...
          { title: 'Counter Input', href: '/components/mui/counter-input', isNew: true },
          { title: 'Unit Input', href: '/components/mui/unit-input', isNew: true },
      ...
      },
      {
        ...
        pages: [
          ...
          { title: 'TipTap RTE', href: '/components/misc/tiptap-rte', isNew: true },
