...
export const PropsDescription = Object.freeze({
  ...
  menuItemProps: (args: PropsDescriptionArgs) => ({
    name: 'menuItemProps',
    description: `[MenuItemProps](${muiDocsUrl(args.muiVersion)}/api/menu-item/) forwarded to every rendered option's \`MenuItem\` — custom \`dense\`, \`divider\`, \`sx\`, etc. \`key\`, \`value\`, \`disabled\` and \`children\` are controlled by the component.`,
    type: `[MenuItemProps](${muiDocsUrl(args.muiVersion)}/api/menu-item/)`,
    hasLinkInType: true
  }),
  inputLabelProps: (args: PropsDescriptionArgs) => ({
    name: 'inputLabelProps',
    description: `[InputLabelProps](${muiDocsUrl(args.muiVersion)}/api/input-label/) forwarded to the internal \`InputLabel\` — the inline label shown inside the field's outline. \`id\`, \`htmlFor\`, \`shrink\`, \`disabled\` and \`children\` are controlled by the component.`,
    type: `[InputLabelProps](${muiDocsUrl(args.muiVersion)}/api/input-label/)`,
    hasLinkInType: true
  }),
  iconButtonProps: (args: PropsDescriptionArgs) => ({
    name: 'iconButtonProps',
    description: `[IconButtonProps](${muiDocsUrl(args.muiVersion)}/api/icon-button/) forwarded to the internal show/hide toggle \`IconButton\` — custom \`size\`, \`sx\`, etc. The interaction/accessibility essentials (\`type\`, \`onClick\`, \`onMouseDown\`, \`edge\`, \`disabled\`, \`aria-label\`) are controlled by the component.`,
    type: `[IconButtonProps](${muiDocsUrl(args.muiVersion)}/api/icon-button/)`,
    hasLinkInType: true
  }),
  circularProgressProps: (args: PropsDescriptionArgs) => ({
    name: 'circularProgressProps',
    description: `[CircularProgressProps](${muiDocsUrl(args.muiVersion)}/api/circular-progress/) forwarded to the loading spinner shown while \`loading\` is true — custom \`color\`, \`size\`, etc.`,
    type: `[CircularProgressProps](${muiDocsUrl(args.muiVersion)}/api/circular-progress/)`,
    hasLinkInType: true
  }),
