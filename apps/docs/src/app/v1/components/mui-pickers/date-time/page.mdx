...
<PropsTable rows={componentPropsV1.MUIDateTimePicker} />
...
<a href={stackblitzFileLink('src/forms/mui-pickers/date-time/index.tsx')} target="_blank" rel="noopener noreferrer">
