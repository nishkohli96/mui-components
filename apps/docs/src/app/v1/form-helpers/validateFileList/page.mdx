...
export const metadata = componentMetadata.validateFileList;
...
This function utilized by [MUIFileUploader](../components/mui/file-uploader) ensures only files meeting the required criteria are passed for further processing.
