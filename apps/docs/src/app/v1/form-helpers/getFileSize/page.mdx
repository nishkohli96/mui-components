...
export const metadata = {
  ...componentMetadata.getFileSize,
  alternates: { canonical: '/form-helpers/getFileSize' }
};
...
This function returns the file size in bytes, kilobytes (**KB**), megabytes (**MB**),
or gigabytes (**GB**), rounded to the nearest whole number or to the specified precision.
