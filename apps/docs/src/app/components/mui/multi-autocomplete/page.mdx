import { DocsPage, PropsTable, Callout, ComponentSourceLink } from '@/components/docs';
...
`MUIMultiAutocomplete` is a multi-select [Autocomplete](https://mui.com/material-ui/react-autocomplete/)
...
<ComponentSourceLink path="mui/multi-autocomplete" />
