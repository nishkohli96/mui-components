...
Components like checkbox or switch also include a [FormControlLabel](https://mui.com/material-ui/api/form-control-label/). 
...
Head over to the [customization example](/examples/customization) to see
`ConfigProvider` applied to a set of reusable form components.
