...
and [FormHelperText](https://v7.mui.com/material-ui/api/form-helper-text/). Components like checkboxes or switches 
also include a [FormControlLabel](https://v7.mui.com/material-ui/api/form-control-label/). 
...
```js
import { ConfigProvider, DefaultMUIComponentsConfig } from '@nish1896/mui-components/config';
```
...
refer to <DemoLink path="/customization">this example</DemoLink>.
